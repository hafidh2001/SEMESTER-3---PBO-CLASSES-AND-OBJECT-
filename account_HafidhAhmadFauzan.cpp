...
int main()
{
	...
	cout << endl;
	Account Account1(15000);
	Account Account2(8000);
	...
	Account2.credit(1300);
	cout << "CREDIT ACCOUNT 1 : Rp. 2000 ,-" << endl;
	cout << "CREDIT ACCOUNT 2 : Rp. 1300 ,-" << endl;
	...
	Account1.debit(500);
	Account2.debit(600);
	cout << "DEBIT ACCOUNT 1 : Rp. 2000 ,-" << endl;
	cout << "DEBIT ACCOUNT 2 : Rp. 1300 ,-" << endl;
